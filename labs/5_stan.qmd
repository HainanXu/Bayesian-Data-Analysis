...
fit2
```
In addition, the variance estimated from the bayes regression is 20.27. The variance for `lm()` is 19.85, which is similat to the variance estimated from bayes regression as well.
```{R}
